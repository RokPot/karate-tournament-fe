...
const toastWrapper = cva("max-w-toast min-h-0 w-auto overflow-hidden rounded-sm border bg-secondary-200 p-0 shadow-4", {
  variants: {
    variant: {
    ...
    <div className="t:flex-row flex w-auto flex-col items-center">
      <div className="py-3-5 flex items-center gap-3 px-4">
        ...
        <Typography
          ...
          className={clsx(
            "font-weight-500",
            variant === "error" ? "text-danger" : "text-neutral-500",
          )}
        >
          {text}
        </Typography>
