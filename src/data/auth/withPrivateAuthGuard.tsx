...
export const withPrivateAuthGuard = <T extends React.PropsWithChildren & WithPrivateAuthGuardProps>(
  WrappedComponent: React.ComponentType<T & WithPrivateAuthGuardProps>,
) => {
  return ({ privateAuthGuardProps, ...props }: T & WithPrivateAuthGuardProps) => {
    return (
