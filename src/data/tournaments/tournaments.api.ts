...
export namespace TournamentsApi {
  export const create = (data: TournamentsModels.CreateTournamentDto) => {
    return AppRestClient.post({ resSchema: CommonModels.TournamentResponseDtoSchema }, `/tournaments`, data);
  };
  ...
  export const findOne = (id: string) => {
    return AppRestClient.get({ resSchema: CommonModels.TournamentResponseDtoSchema }, `/tournaments/${id}`);
  };

  export const update = (id: string, data: TournamentsModels.UpdateTournamentDto) => {
    return AppRestClient.put({ resSchema: CommonModels.TournamentResponseDtoSchema }, `/tournaments/${id}`, data);
  };
